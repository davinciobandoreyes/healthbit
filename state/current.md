...
- Buscador público: hero corto “Encuentra doctores verificados” y foto; sigue en todas las especialidades y se oculta al buscar o al elegir ciudad. Footer: Privacidad y Términos (fase 1, Ley 1581). Búsqueda bajo el header, especialidades con médicos y ciudad en un select. La card abre la ficha; WhatsApp es icono. La ficha no lleva hero.
